    ...
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.4.6/css/flag-icon.min.css">
		<style type="text/css">
			@font-face{
				...
				src: url('https://www.rofa.id/fonts/Avenir-Medium.ttf');
				font-display: swap;
			}
			@font-face{
				font-family: "Bebas Neue Book";
				src: url('https://www.rofa.id/fonts/BebasNeueBook.otf');
				font-display: swap;
			}
			@font-face{
				font-family: "Bebas Neue Regular";
				src: url('https://www.rofa.id/fonts/BebasNeueRegular.otf');
				font-display: swap;
			}
			@font-face{
				font-family: "Bebas Neue Bold";
				src: url('https://www.rofa.id/fonts/BebasNeueBold.otf');
				font-display: swap;
			}
			@font-face{
				font-family: "Panton Light Caps";
				src: url('https://www.rofa.id/fonts/PANTON-LIGHTCAPS.OTF');
				font-display: swap;
			}
			@font-face{
				font-family: "Panton Black Caps";
				src: url('https://www.rofa.id/fonts/PANTON-BLACKCAPS.OTF');
				font-display: swap;
			}
			@font-face{
