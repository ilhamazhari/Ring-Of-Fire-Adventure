...
<div class="container">
	...
	<form id="checkout" method="POST" action="">
		...
		<div class="form-group">
			<div class="row">
				<div class="col-md-5"><input type="text" name="province" placeholder="Province" class="form-control"></div>
				<div class="col-md-5"><input type="text" name="city" placeholder="City" class="form-control"></div>
